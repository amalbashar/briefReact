...
const FoodCategoryV3 = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/api/food-menu`, {
        params: {
          ...
          <div className="food-menu-three-two-items">
            <div className="row">
              <div className="col-lg-12 text-center">
                <div
                  className="nav nav-tabs food-menu-nav style-three"
                  id="nav-tab"
                  role="tablist"
                >
                  <button
                    className={`nav-link ${
                      selectedCategory === "Keto" ? "active" : ""
                    }`}
                  ...
                  <button
                    className={`nav-link ${
                      selectedCategory === "Healthy" ? "active" : ""
                    }`}
                  ...
                  <button
                    className={`nav-link ${
                      selectedCategory === "Diabetes" ? "active" : ""
                    }`}
              ...
              <div className="col-lg-12">
                <div
                  className="tab-content food-style-two-content"
                  id="nav-tabContent"
                >
